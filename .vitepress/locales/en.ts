...
export const en = defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      message: `Released under the GPL-3.0 License | Copyright © 2024-${new Date().getFullYear()} <a href="https://github.com/future0923/" target="_blank">Future0923</a>`,
...
function sidebarGuide(): DefaultTheme.SidebarItem[] {
  return [
    ...
    },
    {
      ...
      items: [
        {text: 'SQL', link: 'sql'},
        {text: 'SQL History', link: 'sql-history'},
      ]
    },
    {
